  ...
  return (
    <footer className='w-full pt-20 pb-10' id="contact">
        ...
        <div className='flex flex-col items-center'>
            ...
            <p className='text-white-500 md:mt-10 my-5'>Reach out to me today and let&apos;s discuss how I can help you achieve your goals.</p>
            <a href="mailto:dzulkiflee@me.com">
                <ShimmerButton title="Lets get in touch" icon={<FaLocationArrow />} position="right" />
            </a>
        </div>
        <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
            <p className="text-sm md:text-base md:font-normal font-light">Copyright ©️ 2024 Dzulkiflee Taib</p>
